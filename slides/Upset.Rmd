...
```{r, echo=FALSE, fig.asp=0.8, fig.width = 5, out.width= "60%"}
library(marginaleffects)
mod %>% 
  marginaleffects::predictions(
    newdata = datagrid(SelfManip = c(-1, 1), ZEI = c(-1, 1)),
...
d %>% 
  ...
  flextable::flextable() %>% 
  flextable::autofit() %>% 
  flextable::color(j = c("cor", "p"), color = "red")
```
]
...
```{r, echo=FALSE}
knitr::include_graphics("./images/result5a_01.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("./images/result5a_02.png")
```
...
d %>% 
  ...
  flextable::flextable() %>% 
  flextable::autofit() %>%
  flextable::color(j = c("statistic", "cor", "p"), color = "red")
```
...
```{r, echo=FALSE}
knitr::include_graphics("./images/result5a_03.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("./images/result5a_04.png")
```
]
...
```{r, echo=FALSE}
knitr::include_graphics("./images/result5a_05.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("./images/result5a_06.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("./images/figure07.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("./images/result5a_07.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("./images/result5a_08.png")
```
...
knitr::include_graphics("./images/result5b_01.png")
```
...
```{r, echo=FALSE, out.width = "90%"}
knitr::include_graphics("./images/result5b_02.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("./images/result5b_03.png")
```
]
...
```{r, echo=FALSE, out.width = "90%"}
knitr::include_graphics("./images/result5b_04.png")
```
...
mod1 %>% 
  flextable::as_flextable() %>% 
  flextable::color(i = c(5, 8), color = "red")
```
...
```{r, echo=FALSE, out.width = "90%"}
knitr::include_graphics("./images/result5b_05.png")
```
...
```{r, echo=FALSE, out.width = "90%"}
knitr::include_graphics("./images/result5c_00.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("./images/result5c_01.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("./images/result5c_02.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("./images/result5c_03.png")
```
]
...
```{r, echo=FALSE}
knitr::include_graphics("./images/result5c_04.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("./images/result5c_05.png")
```
